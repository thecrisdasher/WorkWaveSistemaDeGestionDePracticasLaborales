                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Introduce tu email y por favor espera unos segundos</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('reset.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Enviar enlace de reinicio</button>
                                        </div>
                                    </form>
                                </div>
                                <div id="alert">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <p class="text-white position-relative">Cuanto más sencilla parezca la escritura, más esfuerzo puso realmente el escritor en el proceso.</p>
                            </div>
                        </div>
                    </div>
                </div>
